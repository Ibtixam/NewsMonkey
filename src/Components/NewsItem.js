...
export default function NewsItem(props) {
  ...
  return (
    ...
    <img src={!ImgUrl?"https://img.freepik.com/premium-photo/businessman-using-tech-devices-icons-thin-line-interface_117023-904.jpg?w=2000":ImgUrl} className="card-img-top" alt="..." />
